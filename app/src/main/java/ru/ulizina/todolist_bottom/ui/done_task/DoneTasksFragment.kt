package ru.ulizina.todolist_bottom.ui.done_task
...
import ru.ulizina.todolist_bottom.databinding.FragmentDoneTasksBinding
...
class DoneTasksFragment : Fragment() {
    ...
    private var binding: FragmentDoneTasksBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        addImageButton?.setOnClickListener {
            findNavController().navigate(R.id.action_doneTasksFragment_to_addTaskFragment, null)
        }
...
/*
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(DoneTasksViewModel::class.java)
